...
export default function Banner({
  ...
  return (
    <div className="w-full mt-0 my-6">
      {/* Edge-to-edge full width container with Background Image */}
      <div 
        className="relative overflow-hidden shadow-sm bg-cover bg-center min-h-[420px] flex items-center w-full"
        style={{ backgroundImage: `url(${image})` }}
      >
        {/* Dark / Gradient Overlay for readability */}
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent z-0" />

        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 items-center w-full max-w-7xl mx-auto px-6 lg:px-8">
          
          {/* Left Content Area */}
          <div className="py-12 sm:py-16 space-y-6 text-center lg:text-left flex flex-col justify-center">
