...
import { UpdateProduct as updateProductAction } from "@/lib/actions/Products";
import { useRouter } from "next/navigation";
import { ArrowLeft } from "lucide-react";

const UpdateProduct = ({ productId, initialData, getCats }) => {
  ...
  const [p, setP] = useState(initialData?.price ? String(initialData.price) : "");
  const [s, setS] = useState(initialData?.stock ? String(initialData.stock) : "");
  ...
  return (
    <div className="p-8">
      <h1 className="text-xl font-bold mb-6">Update Product</h1>
